...
const definition = {
        ...
        fromZigbee: [fz.temperature, fz.humidity, fzLocal.illuminance, fzLocal.co2, fzLocal.air_quality, fzLocal.co2_config, fzLocal.co2_config2, fzLocal.temperaturef_config, fzLocal.humidity_config, fzLocal.co2_gasstat_config, fzLocal.voc_gasstat_config],
        toZigbee: [tz.factory_reset, tzLocal.co2_config, tzLocal.co2_config2, tzLocal.temperaturef_config, tzLocal.humidity_config, tzLocal.co2_gasstat_config, tzLocal.voc_gasstat_config],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            minimumReportInterval: 10, maximumReportInterval: 300, reportableChange: 10}];
            await endpoint.configureReporting('msTemperatureMeasurement', payload2);
			const payload3 = [{attribute: {ID: 0x0000, type: 0x21},
            minimumReportInterval: 10, maximumReportInterval: 300, reportableChange: 20}];
			await endpoint.configureReporting('msRelativeHumidity', payload3);
			const payload1 = [{attribute: {ID: 0x0000, type: 0x39},
            minimumReportInterval: 10, maximumReportInterval: 300, reportableChange: 0.000001}];
            ...
            minimumReportInterval: 10, maximumReportInterval: 300, reportableChange: 1}];
			await endpoint4.configureReporting('genAnalogInput', payload5);
        },
        ...
        exposes: [e.co2(),
		    exposes.numeric('voc_index', ea.STATE).withUnit('VOC Index points').withDescription('VOC INDEX'),
			 e.temperature(), e.humidity(), e.illuminance(), e.illuminance_raw(),
